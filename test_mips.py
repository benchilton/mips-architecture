...
if cocotb.simulator.is_running():
    data_size = int(cocotb.top.data_size)
    pc_size = int(cocotb.top.pc_size)
...
class DataValidMonitor:
    ...
    def __init__(
        self, clk: SimHandleBase, nreset: SimHandleBase, datas: Dict[str, SimHandleBase], valid: SimHandleBase
    ):
